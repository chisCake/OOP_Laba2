...
namespace OOP_Laba2 {
    class Strings {
        ...
        private static void Compare() {
            string str1 = "Первая строка", str2 = "Вторая строка", str3 = "Первая строка";
...
#pragma warning restore IDE0059 // Ненужное присваивание значения
            Console.WriteLine("Объявленные переменные:" +
                $"\nstr1: {str1}" +
                $"\nstr2: {str2}" +
                $"\nstr3: {str3}");
        ...
        private static void NullString() {
            string str = "abc", emptyStr = "", nullStr = null;
            Console.WriteLine(
        ...
        private static void StringBuilderExample() {
            ...
            int originalStrLength = sb.Length;
